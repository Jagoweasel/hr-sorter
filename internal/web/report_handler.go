...
func (h *Handler) handleReports(w http.ResponseWriter, r *http.Request) {
	...
	h.templates.RenderWithStatus(w, r, "reports.html", http.StatusOK, dataInterface, h.getLocale(r))
}
...
func (h *Handler) handleExportPDFOptions(w http.ResponseWriter, r *http.Request) {
	accountID := r.URL.Query().Get("account_id")
	h.templates.RenderWithStatus(w, r, "fragments/modals/export_pdf_options.html", http.StatusOK, map[string]string{"AccountID": accountID}, h.getLocale(r))
}
