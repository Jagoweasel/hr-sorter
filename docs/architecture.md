...
### `internal/hhclient`
Handles integration with HeadHunter.
- **OTP Flow**: Managed via a state machine using Playwright-go for browser automation.
- **Auth**: Handles OAuth2 token exchange and lifecycle.
- **Scraper**: Fetches negotiations and vacancy details.
